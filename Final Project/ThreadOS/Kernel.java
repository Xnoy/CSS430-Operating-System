/*  Cameron Padua
    ...
    Kernel.java
    Almost no modifications were made to the kernel besides adding the system
     interuppt calls for the SYslib interrupts. In addition, we added a
     method that will allow for the FileSystem to get the current TCB.
...
public class Kernel {
                ...
                switch (cmd) {
                    ...
                    case READ:
                        ...
                        if ((myTcb = scheduler.getMyTcb()) != null) {
                            ...
                            if (ftEnt != null)
                                return fs.read(myTcb.getFD(ftEnt), (byte[]) args);
                        }
                        return ERROR;
                    case WRITE:
                        switch (param) {
                    ...
                    case CLOSE:   // to be implemented in project
                        if ((myTcb = scheduler.getMyTcb()) != null) {
                            ...
                            if (entry == null || fs.close(param) == -1)
                                return ERROR;
                            if (myTcb.returnFd(param) != entry) {
                                SysLib.cout("Error in closed in Kernel 2");
                                return ERROR;
                            }
                            return OK;
                        }
                    ...
                    case SEEK:    // to be implemented in project
                        if ((myTcb = scheduler.getMyTcb()) != null) {
                            ...
                            if (myTcb.getFtEnt(param) != null)
                                return fs.seek(param, seekArgs[0], seekArgs[1]);
                        }
                        return ERROR;
    ...
    public static TCB getThreadTcb() {
